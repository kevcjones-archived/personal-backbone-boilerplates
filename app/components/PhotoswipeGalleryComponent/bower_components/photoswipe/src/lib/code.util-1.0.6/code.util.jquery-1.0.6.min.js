...
var a=document.createElement("div");this.is3dSupported=!b.isNothing(a.style.WebkitPerspective);this.isCSSTransformSupported=!b.isNothing(a.style.WebkitTransform)||!b.isNothing(a.style.MozTransform)||!b.isNothing(a.style.transformProperty);this.isTouchSupported=this.isEventSupported("touchstart");this.isGestureSupported=this.isEventSupported("gesturestart")},_eventTagNames:{select:"input",change:"input",submit:"form",reset:"form",error:"img",load:"img",abort:"img"},isEventSupported:function(a){var d=
document.createElement(this._eventTagNames[a]||"div"),c,a="on"+a;c=b.objectHasProperty(d,a);c||(d.setAttribute(a,"return;"),c=typeof d[a]==="function");return c},isLandscape:function(){return b.DOM.windowWidth()>b.DOM.windowHeight()}};b.Browser._detect()})(window,window.Code.Util);
(function(e,b,a){a.extend(a,{Events:{add:function(d,a,e){b(d).bind(a,e)},remove:function(d,a,e){b(d).unbind(a,e)},fire:function(a,c){var e,f=Array.prototype.slice.call(arguments).splice(2);e=typeof c==="string"?{type:c}:c;b(a).trigger(b.Event(e.type,e),f)},getMousePosition:function(a){return{x:a.pageX,y:a.pageY}},getTouchEvent:function(a){return a.originalEvent},getWheelDelta:function(d){var b=0;a.isNothing(d.wheelDelta)?a.isNothing(d.detail)||(b=-d.detail/3):b=d.wheelDelta/120;return b},domReady:function(a){b(document).ready(a)}}})})(window,
...
"TimingFunction"]="";d[this._transitionPrefix+"Delay"]="";d[this._transformLabel]="";b.DOM.setStyle(a,d)}else b.isNothing(e.jQuery)||e.jQuery(a).stop(!0,!0)},fadeIn:function(a,d,c,g,f){f=b.coalesce(f,1);f<=0&&(f=1);if(d<=0&&(b.DOM.setStyle(a,"opacity",f),!b.isNothing(c))){c(a);return}b.DOM.getStyle(a,"opacity")>=1&&b.DOM.setStyle(a,"opacity",0);b.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",f,d,c,g):b.isNothing(e.jQuery)||e.jQuery(a).fadeTo(d,f,c)},fadeTo:function(a,d,b,e,f){this.fadeIn(a,
b,e,f,d)},fadeOut:function(a,d,c,g){if(d<=0&&(b.DOM.setStyle(a,"opacity",0),!b.isNothing(c))){c(a);return}b.Browser.isCSSTransformSupported?this._applyTransition(a,"opacity",0,d,c,g):e.jQuery(a).fadeTo(d,0,c)},slideBy:function(a,d,c,g,f,h){var i={},d=b.coalesce(d,0),c=b.coalesce(c,0),h=b.coalesce(h,"ease-out");i[this._transitionPrefix+"Property"]="all";i[this._transitionPrefix+"Delay"]="0";g===0?(i[this._transitionPrefix+"Duration"]="",i[this._transitionPrefix+"TimingFunction"]=""):(i[this._transitionPrefix+
...
y:a[0].pageY}},fireTouchEvent:function(d){var b=0,g=0,f=0,h,b=this.touchEndPoint.x-this.touchStartPoint.x,g=this.touchEndPoint.y-this.touchStartPoint.y,f=Math.sqrt(b*b+g*g);if(this.captureSettings.swipe&&(h=new Date,h-=this.touchStartTime,h<=this.swipeTimeThreshold)){if(e.Math.abs(b)>=this.swipeThreshold){a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,action:b<0?a.TouchElement.ActionTypes.swipeLeft:a.TouchElement.ActionTypes.swipeRight,targetEl:d.target,
currentTargetEl:d.currentTarget});return}if(e.Math.abs(g)>=this.swipeThreshold){a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,action:g<0?a.TouchElement.ActionTypes.swipeUp:a.TouchElement.ActionTypes.swipeDown,targetEl:d.target,currentTargetEl:d.currentTarget});return}}f>1?a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,action:a.TouchElement.ActionTypes.touchMoveEnd,point:this.touchEndPoint,targetEl:d.target,currentTargetEl:d.currentTarget}):
this.captureSettings.doubleTap?a.isNothing(this.doubleTapTimeout)?this.doubleTapTimeout=e.setTimeout(function(){this.doubleTapTimeout=null;a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,action:a.TouchElement.ActionTypes.tap,targetEl:d.target,currentTargetEl:d.currentTarget})}.bind(this),this.doubleTapSpeed):(e.clearTimeout(this.doubleTapTimeout),this.doubleTapTimeout=null,a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,
action:a.TouchElement.ActionTypes.doubleTap,targetEl:d.target,currentTargetEl:d.currentTarget})):a.Events.fire(this,{type:a.TouchElement.EventTypes.onTouch,target:this,point:this.touchEndPoint,action:a.TouchElement.ActionTypes.tap,targetEl:d.target,currentTargetEl:d.currentTarget})},onTouchStart:function(b){this.captureSettings.preventDefaultTouchEvents&&b.preventDefault();a.Events.remove(this.el,"mousedown",this.mouseDownHandler);var c=a.Events.getTouchEvent(b).touches;c.length>1&&this.captureSettings.gesture?
